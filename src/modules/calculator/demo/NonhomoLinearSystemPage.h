#ifndef ALGEMATE_NONHOMOLINEARSYSTEMPAGE_H
#define ALGEMATE_NONHOMOLINEARSYSTEMPAGE_H
...
class NonhomoLinearSystemPage : public QWidget {
    Q_OBJECT
public:
    explicit NonhomoLinearSystemPage(QWidget* parent = nullptr);
