...
void GSOPage::onDemo() {
    ...
    cells_[0]->setText(QStringLiteral("2"));   
    cells_[1]->setText(QStringLiteral("-1"));  
    cells_[2]->setText(QStringLiteral("0"));   
    cells_[3]->setText(QStringLiteral("2"));   
    cells_[4]->setText(QStringLiteral("0"));   
    cells_[5]->setText(QStringLiteral("1"));   
